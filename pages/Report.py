...
# Calculate the summary data for display and export
...
# Add the "Total" row to the summary data
...
# Display the "Summary" data in Streamlit with Excel-like formatting
